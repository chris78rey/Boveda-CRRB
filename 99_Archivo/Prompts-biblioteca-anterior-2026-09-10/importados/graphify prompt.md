...
2. **Confirmación con el Usuario:**
   * En tu primer mensaje al retomar la sesión, presenta un resumen claro de lo que detectaste: *"He detectado que la sesión anterior se interrumpió. El estado actual de Git muestra estos cambios pendientes: {{archivos modificados / último commit}}."*
